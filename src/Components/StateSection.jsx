    ...
    <div className="w-full bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white">
      <div className="container mx-auto flex justify-center">
        <div className="stats stats-vertical lg:stats-horizontal shadow w-full overflow-x-hidden">
          <div className="stat place-items-center space-y-2 my-8 lg:my-15  lg:border-r-2 lg:border-r-gray-300">
            <div className="stat-value text-5xl">50K+</div>
            <div className="stat-desc text-2xl text-gray-300">Active Users</div>
          </div>

          <div className="stat place-items-center space-y-2 my-8 lg:my-15 border-r-2 border-r-gray-300">
            <div className="stat-value text-5xl">200K+</div>
            <div className="stat-desc text-2xl text-gray-300">
              Premium Tools
            </div>
          </div>

          <div className="stat place-items-center space-y-2 my-8 lg:my-15">
